  ...
  <div class="container">
    <div class="section section-1" ref="section1" @click="expandSection(1)" @mouseenter="expandSection(1)"
      ...
      <nuxt-link to="/voiceover" class="content" v-if="activeSection === 1">
        <!--        <img src="/shared/voiceover-preview.svg" alt="Voiceover Preview" class="preview-img">-->
        <voiceover/>
      </nuxt-link>
...
<script>
import Law from "~/pages/law/index.vue";
import Voiceover from "~/pages/voiceover/index.vue";
import Ngo from "~/pages/ngo/index.vue";

export default {
  components: {Law, Voiceover, Ngo},
  data() {
    return {
      activeSection: null
    }
